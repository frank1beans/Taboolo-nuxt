...
const handleExecute = async () => {
  ...
  try {
    ...
    const message =
      error?.data?.message || error?.message || 'Errore durante l\'import del file SIX'
    ...
    <div v-if="wizardState.isExecuting || wizardState.result || wizardState.error" class="space-y-4">
      ...
      >
        <div class="flex items-start gap-4">
          <UIcon name="i-lucide-check-circle-2" class="h-6 w-6 text-green-600 flex-shrink-0 mt-0.5" />
          <div class="flex-1">
      ...
      <div v-if="wizardState.error" class="rounded-lg border border-destructive bg-destructive/10 p-6">
        <div class="flex items-start gap-4">
          <UIcon name="i-lucide-x-circle" class="h-6 w-6 text-destructive flex-shrink-0 mt-0.5" />
          <div class="flex-1">
