...
<template>
  ...
  >
      ...
      <div class="grid grid-cols-3 gap-2">
        ...
        <div class="space-y-1">
          ...
          <Select
            ...
            @update:model-value="(val) => handleUpdate('sheet', typeof val === 'string' ? val : String(val))"
          />
        </div>
        ...
        <div class="space-y-1">
          ...
          <Input
            ...
            @update:model-value="(val) => handleUpdate('enterprise', String(val))"
          />
        </div>
        ...
        <div class="space-y-1">
          ...
          <Input
            ...
            @update:model-value="(val) => handleUpdate('round', String(val))"
          />
        </div>
      </div>
    ...
    <button
      type="button"
      class="flex-shrink-0 p-1.5 rounded-full text-muted-foreground hover:bg-destructive/10 hover:text-destructive transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      :disabled="isDisabled"
      @click="handleRemove"
    >
